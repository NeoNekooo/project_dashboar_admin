...
return [
    ...
    */
    ...
    'logo' => '<b>Admin</b>LTE', // Tetap statis di sini, dinamisasi dilakukan di Blade
    ...
    'menu' => [
        ...
        [
            ...
            'submenu'       => [
                ...
                // Bagian ini sudah Anda komentari/hapus, jadi aman
                // [
                //     'text' => 'Kontak & Medsos',
                //     'url'  => 'instansi/profile#kontak',
                //     'icon' => 'far fa-circle',
                // ],
            ],
        ...
        // Jika ini adalah menu Manajemen User yang terpisah dan hanya untuk Admin, pastikan 'can' => 'admin' juga ada.
        [
            'text'          => 'Kepegawaian', // Ada typo di sini jika seharusnya 'Instansi'
            'icon'          => 'fas fa-fw fa-users',
            'can'           => 'admin', // <-- Pastikan ini ada
            'submenu'       => [
                ['text' => 'Manajemen User', 'url' => 'admin/users', 'icon' => 'fas fa-fw fa-users'],
                // Anda punya duplikat baris ini, mungkin perlu dihapus salah satu.
                ['text' => 'Manajemen User', 'url' => 'admin/users', 'icon' => 'fas fa-fw fa-users'],
            ],
        ],
    ...
    */
    'footer' => [
        'enabled' => false, // <--- INI SUDAH SAYA UBAH JADI FALSE
        'text' => '', // Teks ini tidak akan ditampilkan karena 'enabled' false
    ],
];